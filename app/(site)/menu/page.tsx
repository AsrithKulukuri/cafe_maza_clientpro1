...
export default function MenuPage() {
    ...
    return (
        <div className="mx-auto max-w-7xl px-6 pb-20 md:px-10">
            ...
            <div className="sticky top-20 z-30 mb-8 rounded-2xl border border-[#D4AF37]/18 bg-[#101010]/92 p-3 shadow-[0_18px_40px_rgba(0,0,0,0.28)] backdrop-blur-xl md:top-22">
                ...
                <div className="flex snap-x gap-2 overflow-x-auto pb-1">
                    {categories.map((category) => (
                        <button
                            ...
                            className={`shrink-0 snap-start rounded-full border px-4 py-2 text-xs transition ${active === category.id
