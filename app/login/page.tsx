        ...
        <div className="grid min-h-screen md:grid-cols-2">
            ...
            <div className="flex items-center justify-center bg-[#0B0B0B] p-6">
                <form className="glass-card w-full max-w-md rounded-3xl border border-[#CFAF63]/25 p-7">
                    ...
                    <h1 className="mt-2 font-[var(--font-heading)] text-4xl text-[#F5F5F5]">Welcome Back</h1>
                    <div className="mt-6 space-y-4">
                        ...
                        <button className="w-full rounded-full bg-gradient-to-r from-[#CFAF63] to-[#FF6A00] px-4 py-3 font-semibold text-[#111]">Sign In</button>
                    </div>
                </form>
            </div>
        </div>
